...
if __name__ == "__main__":
    ...
    models = {}
    models.update({"classification": get_classification_approach()})
    # models.update({"regression": get_regression_approach()})

    world_cup = MatchPrediction(spark, year, "./src/test/pyspark/model",
