...
class Stacking:
    ...
    def load_all_data(self):
        ...
        for classifier in self.classifier_available[1:]:
            dic_data[classifier] = (self.spark.read
                                    .csv(os.path.join(self.path, classifier), sep=",", header=True,
    ...
    def create_features(self, data):
        if len(self.classifier_available) == 2:
            ...
            self.new_data = data.withColumn("features", udf_features(col(self.classifier_models[0]),
    ...
    def save_best_model(self):
        (self.stacking_model
         .write()
         .overwrite()
         .save("../test/classification_model/stacking/{0}".format(self.classifier_stacking)))
